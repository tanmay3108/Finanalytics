class CommonDatabaseRouter(object):
    """
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'common' and obj2._meta.app_label == 'common':
            return True
        # No opinion if neither object is in the Example app (defer to default or other routers).
        elif 'common' not in [obj1._meta.app_label, obj2._meta.app_label]:
            return None
